...
export default function NeuralNetwork({
 ...
 <h1 className="font-space-mono    text-6xl  w-[70vw]   font-mono font-medium md:-tracking-[12px] md:text-[10rem] md:leading-36 uppercase">
       
        Recover\<br /> <div className='flex gap-8 '><span className='inline'>ing</span> <span> lost</span></div>  cultures.
