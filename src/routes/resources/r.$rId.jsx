                ...
                <div className="flex items-center flex-wrap pb-4   border-gray-800 border-opacity-75 mt-auto w-full">
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      <span className="title-font font-medium text-white">created by {resourceMaterial.createdBy}</span>
                      <span className="text-muted-foreground text-xs  mt-0.5">username {resourceMaterial.createdBy}</span>
                    </span>
                  </a>
